...
describe('ngbx-datepicker-navigation-select', () => {

  beforeEach(() => {
    TestBed.overrideModule(NgbxDatepickerModule, {set: {exports: [NgbxDatepickerNavigationSelect]}});
  ...
  it('should generate month options correctly', () => {
    const fixture =
        createTestComponent(`<ngbx-datepicker-navigation-select [date]="date" [months]="months" [years]="years">`);
  ...
  it('should send date selection events', () => {
    const fixture = createTestComponent(
        `<ngbx-datepicker-navigation-select [date]="date" [months]="months" [years]="years" (select)="onSelect($event)">`);
    ...
    expect(fixture.componentInstance.onSelect).toHaveBeenCalledWith(new NgbxDate(2016, 10, 1));

    changeSelect(yearSelect, '2017');
    expect(fixture.componentInstance.onSelect).toHaveBeenCalledWith(new NgbxDate(2017, 8, 1));

    // out of range
    changeSelect(yearSelect, '2000');
    expect(fixture.componentInstance.onSelect).toHaveBeenCalledWith(new NgbxDate(NaN, 8, 1));
  });
  ...
  it('should have disabled select boxes when disabled', () => {
    const fixture = createTestComponent(
        `<ngbx-datepicker-navigation-select [disabled]="true" [date]="date" [months]="months" [years]="years">`);
  ...
  it('should have correct aria attributes on select options', () => {
    const fixture =
        createTestComponent(`<ngbx-datepicker-navigation-select [date]="date" [months]="[7, 8, 9]" [years]="years">`);
