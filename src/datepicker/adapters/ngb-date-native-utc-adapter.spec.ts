import {NgbxDateNativeUTCAdapter} from './ngbx-date-native-utc-adapter';

describe('ngbx-date-native-utc model adapter', () => {
  let adapter: NgbxDateNativeUTCAdapter;

  beforeEach(() => { adapter = new NgbxDateNativeUTCAdapter(); });
