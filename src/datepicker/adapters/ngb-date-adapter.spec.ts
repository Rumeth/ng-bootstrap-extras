import {NgbxDateStructAdapter} from './ngbx-date-adapter';

describe('ngbx-date model adapter', () => {
  let adapter: NgbxDateStructAdapter;

  beforeEach(() => { adapter = new NgbxDateStructAdapter(); });
