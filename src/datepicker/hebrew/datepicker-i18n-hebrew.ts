...
import {NgbxDateStruct} from '../../index';
 ...
 */
@Injectable()
export class NgbxDatepickerI18nHebrew extends NgbxDatepickerI18n {
  ...
  getDayNumerals(date: NgbxDateStruct): string { return hebrewNumerals(date.day); }
