...
describe('ngbx-modal-dialog', () => {

  let fixture: ComponentFixture<NgbxModalWindow>;

  beforeEach(() => {
    TestBed.configureTestingModule({declarations: [NgbxModalWindow]});
    fixture = TestBed.createComponent(NgbxModalWindow);
  });
