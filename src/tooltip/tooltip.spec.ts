...
import {NgbxTooltipModule} from './tooltip.module';
import {NgbxTooltipWindow, NgbxTooltip} from './tooltip';
...
describe('ngbx-tooltip-window', () => {
  beforeEach(() => { TestBed.configureTestingModule({imports: [NgbxTooltipModule]}); });

  it('should render tooltip on top by default', () => {
    const fixture = TestBed.createComponent(NgbxTooltipWindow);
...
describe('ngbx-tooltip', () => {

  beforeEach(() => {
    TestBed.configureTestingModule({declarations: [TestComponent, TestOnPushComponent], imports: [NgbxTooltipModule]});
  });

  function getWindow(element) { return element.querySelector('ngbx-tooltip-window'); }

  describe('basic functionality', () => {

    it('should open and close a tooltip - default settings and content as string', () => {
      const fixture = createTestComponent(`<div ngbxTooltip="Great tip!"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      const defaultConfig = new NgbxTooltipConfig();
      ...
      expect(windowEl.getAttribute('id')).toBe('ngbx-tooltip-0');
      expect(windowEl.parentNode).toBe(fixture.nativeElement);
      expect(directive.nativeElement.getAttribute('aria-describedby')).toBe('ngbx-tooltip-0');
    ...
    it('should open and close a tooltip - default settings and content from a template', () => {
      const fixture = createTestComponent(`<ng-template #t>Hello, {{name}}!</ng-template><div [ngbxTooltip]="t"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      expect(windowEl.getAttribute('role')).toBe('tooltip');
      expect(windowEl.getAttribute('id')).toBe('ngbx-tooltip-1');
      expect(windowEl.parentNode).toBe(fixture.nativeElement);
      expect(directive.nativeElement.getAttribute('aria-describedby')).toBe('ngbx-tooltip-1');
    ...
    it('should open and close a tooltip - default settings, content from a template and context supplied', () => {
      const fixture = createTestComponent(`<ng-template #t let-name="name">Hello, {{name}}!</ng-template><div [ngbxTooltip]="t"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      expect(windowEl.getAttribute('role')).toBe('tooltip');
      expect(windowEl.getAttribute('id')).toBe('ngbx-tooltip-2');
      expect(windowEl.parentNode).toBe(fixture.nativeElement);
      expect(directive.nativeElement.getAttribute('aria-describedby')).toBe('ngbx-tooltip-2');
    ...
    it('should open and close a tooltip - default settings and custom class', () => {
      const fixture = createTestComponent(`
        <div ngbxTooltip="Great tip!" tooltipClass="my-custom-class"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      expect(windowEl.textContent.trim()).toBe('Great tip!');
      expect(windowEl.getAttribute('role')).toBe('tooltip');
      expect(windowEl.getAttribute('id')).toBe('ngbx-tooltip-3');
      expect(windowEl.parentNode).toBe(fixture.nativeElement);
      expect(directive.nativeElement.getAttribute('aria-describedby')).toBe('ngbx-tooltip-3');
    ...
    it('should not open a tooltip if content is falsy', () => {
      const fixture = createTestComponent(`<div [ngbxTooltip]="notExisting"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    it('should close the tooltip tooltip if content becomes falsy', () => {
      const fixture = createTestComponent(`<div [ngbxTooltip]="name"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    it('should not open a tooltip if [disableTooltip] flag', () => {
      const fixture = createTestComponent(`<div [ngbxTooltip]="Disabled!" [disableTooltip]="true"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    it('should not leave dangling tooltips in the DOM', () => {
      const fixture = createTestComponent(`<ng-template [ngIf]="show"><div ngbxTooltip="Great tip!"></div></ng-template>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    it('should properly cleanup tooltips with manual triggers', () => {
      const fixture = createTestComponent(`
            <ng-template [ngIf]="show">
              <div ngbxTooltip="Great tip!" triggers="manual" #t="ngbxTooltip" (mouseenter)="t.open()"></div>
            </ng-template>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    describe('positioning', () => {
      ...
      it('should use requested position', () => {
        const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" placement="left"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should properly position tooltips when a component is using the OnPush strategy', () => {
        const fixture = createOnPushTestComponent(`<div ngbxTooltip="Great tip!" placement="left"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should have proper arrow placement', () => {
        const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" placement="right-top"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should accept placement in array (second value of the array should be applied)', () => {
        const fixture =
            createTestComponent(`<div ngbxTooltip="Great tip!" [placement]="['left-top','top-left']"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should accept placement with space separated values (second value should be applied)', () => {
        const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" placement="left-top top-left"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should apply auto placement', () => {
        const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" placement="auto"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    describe('triggers', () => {
      ...
      it('should support toggle triggers', () => {
        const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" triggers="click"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should non-default toggle triggers', () => {
        const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" triggers="mouseenter:click"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should support multiple triggers', () => {
        const fixture =
            createTestComponent(`<div ngbxTooltip="Great tip!" triggers="mouseenter:mouseleave click"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should not use default for manual triggers', () => {
        const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" triggers="manual"></div>`);
        const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
      ...
      it('should allow toggling for manual triggers', () => {
        const fixture = createTestComponent(`
                <div ngbxTooltip="Great tip!" triggers="manual" #t="ngbxTooltip"></div>
  ...
  describe('container', () => {
    ...
    it('should be appended to the element matching the selector passed to "container"', () => {
      const selector = 'body';
      const fixture = createTestComponent(`<div ngbxTooltip="Great tip!" container="` + selector + `"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    it('should properly destroy tooltips when the "container" option is used', () => {
      const selector = 'body';
      const fixture =
          createTestComponent(`<div *ngIf="show" ngbxTooltip="Great tip!" container="` + selector + `"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
  ...
  describe('visibility', () => {
    it('should emit events when showing and hiding tooltip', () => {
      const fixture = createTestComponent(
          `<div ngbxTooltip="Great tip!" triggers="click" (shown)="shown()" (hidden)="hidden()"></div>`);
      const directive = fixture.debugElement.query(By.directive(NgbxTooltip));
    ...
    it('should not emit close event when already closed', () => {
      const fixture = createTestComponent(
          `<div ngbxTooltip="Great tip!" triggers="manual" (shown)="shown()" (hidden)="hidden()"></div>`);
  ...
  describe('Custom config', () => {
    let config: NgbxTooltipConfig;

    beforeEach(() => {
      TestBed.configureTestingModule({imports: [NgbxTooltipModule]});
      TestBed.overrideComponent(TestComponent, {set: {template: `<div ngbxTooltip="Great tip!"></div>`}});
    });

    beforeEach(inject([NgbxTooltipConfig], (c: NgbxTooltipConfig) => {
      config = c;
  ...
  describe('Custom config as provider', () => {
    let config = new NgbxTooltipConfig();
    config.placement = 'bottom';
    config.triggers = 'click';
    config.container = 'body';
    config.tooltipClass = 'my-custom-class';
    ...
    beforeEach(() => {
      TestBed.configureTestingModule(
          {imports: [NgbxTooltipModule], providers: [{provide: NgbxTooltipConfig, useValue: config}]});
    });
  ...
  describe('non-regression', () => {
    ...
    it('should not try to call listener cleanup function when no listeners registered', () => {
      const fixture = createTestComponent(`
        <ng-template #tpl><div ngbxTooltip="Great tip!"></div></ng-template>
...
export class TestComponent {
  ...
  @ViewChild(NgbxTooltip) tooltip: NgbxTooltip;
